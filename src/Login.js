    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-blue-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-800 to-blue-600 px-8 py-8 text-center">
          ...
          <h1 className="text-white text-xl font-bold">Canal Ultra Popular</h1>
          <p className="text-blue-200 text-sm mt-1">Sistema de mensagens confidenciais</p>
        </div>
              ...
              <form onSubmit={handleLogin} className="flex flex-col gap-4">
                <div>
                  ...
                  <input type="email" placeholder="seu@email.com" required
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm focus:border-blue-400 focus:outline-none transition-colors"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type={showPass ? "text" : "password"} placeholder="Sua senha" required
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm focus:border-blue-400 focus:outline-none transition-colors pr-12"
                ...
                <button type="submit" disabled={loading}
                  className="w-full bg-blue-700 hover:bg-blue-800 text-white py-3 rounded-xl font-bold text-sm transition-colors disabled:opacity-50 mt-1">
              ...
              {resetOk ? (
                ...
                <div className="flex flex-col gap-3">
                  <input type="email" placeholder="Seu e-mail"
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm focus:border-blue-400 focus:outline-none"
                  ...
                  <button onClick={handleReset} disabled={loading}
                    ...
                    {loading ? "Enviando..." : "Solicitar redefincao"}
                  </button>
                </div>
              )}
            </>
